...
// Функция для создания пунктов меню с использованием переводов
const getNavItems = (t: (key: string) => string): NavItem[] => [
  ...
  },
  {
    ...
    name: t("users"),
    subItems: [
      { name: t("all_users"), path: "/users/users-all", pro: false },
      { name: t("roles"), path: "/users/roles", pro: false },
    ],
  },
];
...
const AppSidebar: React.FC = () => {
  ...
  // 🔥 Используем useMemo для мемоизации navItems
