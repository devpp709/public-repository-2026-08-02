...
class CarService
{
     ...
     */
    public function getAvailableForPeriod(\DateTimeInterface $startDate, \DateTimeInterface $endDate): array
    {
        $cars = $this->carRepository->findAvailableForPeriod($startDate, $endDate);
        return CarResponseDTO::fromEntities($cars);
    }
