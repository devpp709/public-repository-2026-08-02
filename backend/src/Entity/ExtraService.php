...
class ExtraService
{
    ...
    #[ORM\OneToMany(targetEntity: CarExtraService::class, mappedBy: 'extraService')]
    private ArrayCollection $carExtraServices;

    #[ORM\OneToMany(targetEntity: BookingExtra::class, mappedBy: 'extraService')]
    private ArrayCollection $bookingExtras;
