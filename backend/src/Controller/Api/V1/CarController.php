...
class CarController extends AbstractController
{
    ...
    public function getAvailable(Request $request): JsonResponse
    {
        ...
        $pickupLocation = $request->query->get('pickup_location');
        $dropoffLocation = $request->query->get('dropoff_location');
        $returnSameLocation = $request->query->get('return_same_location');
        $driverAge18to40 = $request->query->get('driver_age_18_40');
        ...
        $params = [
            ...
            'driver_age_18_40' => $driverAge18to40,
        ];
        ...
        if ($startDate && $endDate) {
            ...
            $cars = $this->carService->getAvailableForPeriod($start, $end, $params);
        } else {
            $cars = $this->carService->getAvailableCars($params);
        }
